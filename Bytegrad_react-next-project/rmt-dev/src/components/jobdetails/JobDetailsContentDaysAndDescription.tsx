...
export default function JobDetailsContentDaysAndDescription({ jobHighligthed }: JobDetailsContentDaysAndDescriptionProps) {
    const daysAgo = jobHighligthed.daysAgo;
    const description = jobHighligthed.description;
    
    return (
        <div className="content__days-and-description content__days-and-description--active">
            <div>{daysAgo}d</div>

...
export default function JobItem({
    ...
    return (
        <div className={`job-item ${active && 'job-item--active'}`} onClick={onClick}>
            <div className="job-item__acronym">{badgeLetters}</div>
            <div className="job-item__text">
                <h3>{title}</h3>
                <p>{company}</p>
            </div>
            <div className={`bookmark-syb-and-days ${isBookmarked && "bookmark-syb-and-days--active"}`}>
                <svg

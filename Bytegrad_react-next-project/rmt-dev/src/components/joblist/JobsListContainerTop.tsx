...
type JobsListContainerTopProps = {
    jobItems: TJobItem[],
    isRelevantFilter: boolean,
    onRelevantFilter: () => void,
    onRecentFilter: () => void
};

export default function JobsListContainerTop({ 
    jobItems, 
    isRelevantFilter, 
    onRelevantFilter,
    onRecentFilter }: JobsListContainerTopProps) {
    
    const results = jobItems.length;
